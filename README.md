...
壁とボムの衝突回数を表示するCountersPlusのカスタムカウンター  
ミス数は0でも、今フルコンボを維持しているのだろうかと不安に駆られてしまうことはありませんか？
...
**Counter X Offset**：カウンターを表示するX座標のオフセット  
**Counter Y Offset**：カウンターを表示するY座標のオフセット  

※このModはCounters+が必要となります。
